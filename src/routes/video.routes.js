...
import { uploadVideo, getAllPaginatedVideo, getSingleVideo, getVideosByUploader, deleteVideo, watchVideo } from "../controllers/video.controller.js"
...
router.get("/video/:videoId", optionalJWT, watchVideo);
